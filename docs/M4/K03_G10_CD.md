...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C03-01* | *Warga* | *Menyimpan data akun warga yang mengirimkan laporan untuk memvalidasi status keanggotaan terdaftar.* |
| *C03-02* | *LaporanGangguan* | *Menyimpan formulir laporan gangguan yang dibuat warga (jenis gangguan, deskripsi, foto pendukung) yang otomatis ditetapkan berstatus "Menunggu".* |
| *C03-03* | *StatusLaporan* | *Enumerasi yang menyimpan nilai batas status laporan yang valid.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C03-01* | *Warga* | *idWarga, nama, statusTerdaftar* | *validasiKeanggotaan(), kirimLaporan()* |
| *C03-02* | *LaporanGangguan* | *idLaporan, idWarga, jenisGangguan, deskripsi, fotoPendukung, waktuDibuat, status* | *setStatusMenunggu(), simpan()* |
| *C03-03* | *StatusLaporan* | *MENUNGGU, SEDANG_DIPERBAIKI, SELESAI* | *-* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C04-01* | *Warga* | *Aktor yang menelusuri daftar riwayat laporan gangguan berdasarkan identitasnya.* |
| *C04-02* | *LaporanGangguan* | *Menyimpan data laporan yang pernah dikirim oleh warga beserta status terkininya untuk ditampilkan pada sistem.* |
| *C04-03* | *RiwayatStatusLaporan* | *Menyimpan riwayat perkembangan status laporan gangguan dari waktu ke waktu.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C04-01* | *Warga* | *idWarga, nama* | *lihatDaftarLaporan(), pilihLaporan()* |
| *C04-02* | *LaporanGangguan* | *idLaporan, idWarga, jenisGangguan, deskripsi, statusLengkap* | *getLaporanByIdWarga(), getDetailLaporan()* |
| *C04-03* | *RiwayatStatusLaporan* | *idRiwayat, idLaporan, status, timestamp* | *getRiwayatPerkembangan()* |
...
> **Catatan integrasi (Rafiandhi):** UC08 ditangani Andro. Kelas global terkait telah diintegrasikan pada Bab 4.1 (C27 CatatanPemeliharaan → C07 Perangkat, C03 Teknisi).
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C09-01 | Pengurus | Pengguna yang berwenang mengakses dashboard administratif dan melihat analitik pemakaian komunal. |
| C09-02 | Periode | Merepresentasikan periode yang dipilih untuk mengelompokkan dan membandingkan data pemakaian. |
| C09-03 | DataPemakaian | Menyimpan data pemakaian air atau energi yang dapat dikelompokkan dan dianalisis berdasarkan periode. |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C09-01 | Pengurus | idPengurus, nama | verifikasiKewenangan() |
| C09-02 | Periode | idPeriode, bulan, tahun | - |
| C09-03 | DataPemakaian | idPemakaian, idWarga, volumeAirM3, energiKWh, waktuCatat | isLengkap() |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C08-01* | *Teknisi* | *Akun petugas yang melakukan pengisian formulir pencatatan pemeliharaan..* |
| *C08-02* | *CatatanPemeliharaan* | *Entri log yang menyimpan rincian perawatan fisik alat (waktu pelaksanaan, tindakan, catatan hasil).* |
| *C08-03* | *Perangkat* | *Menyimpan detail alat komunal yang sedang dicatat riwayat perbaikannya oleh teknisi.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C08-01* | *Teknisi* | *idTeknisi, nama* | *buatCatatanPemeliharaan()* |
| *C08-02* | *CatatanPemeliharaan* | *idCatatan, idTeknisi, idPerangkat, waktuPelaksanaan, tindakan, catatanHasil* | *validasiFormulir(), simpan()* |
| *C08-03* | *Perangkat* | *idPerangkat, namaPerangkat, lokasi* | *getRiwayatPemeliharaan()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C11-01 | Pengurus | Pengguna berwenang yang memilih periode dan membuat rekapitulasi administratif. |
| C11-02 | Periode | Merepresentasikan periode pemakaian dan iuran yang akan direkapitulasi. |
| C11-03 | DataPemakaian | Menyimpan data pemakaian air atau energi beserta status finalnya. |
| C11-04 | Tagihan | Menyimpan data iuran warga beserta status final untuk periode terkait. |
| C11-05 | Rekapitulasi | Merepresentasikan rekapitulasi pemakaian dan iuran yang dapat dihasilkan, diekspor, atau dicetak. |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C11-01 | Pengurus | idPengurus, nama | verifikasiKewenangan(), buatRekapitulasi() |
| C11-02 | Periode | idPeriode, bulan, tahun, statusFinal | isFinal() |
| C11-03 | DataPemakaian | idPemakaian, idWarga, volumeAirM3, energiKWh, waktuCatat | isLengkap() |
| C11-04 | Tagihan | idTagihan, idWarga, idPeriode, jumlahIuran, dataPemakaianDasar, status | sudahFinal(), rincian() |
| C11-05 | StatusTagihan | DRAFT, FINAL | - |
| C11-06 | Rekapitulasi | idRekap, idPeriode, totalPemakaianAir, totalPemakaianEnergi, totalIuran | generate(periode), ekspor(), cetak() |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C14-01 | Akun | Menyimpan identitas pengguna dan status persetujuan akun yang dapat diperbarui setelah proses peninjauan. |
| C14-02 | Pengurus | Bentuk khusus akun yang berwenang meninjau serta menyetujui atau menolak akun yang menunggu persetujuan. |
| C14-03 | StatusAkun | Merepresentasikan status persetujuan akun, seperti Menunggu Persetujuan, Disetujui, atau Ditolak. |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C14-01 | Akun | email, password, nama, statusAkun | ubahStatus() |
| C14-02 | Pengurus | idPengurus, nama | lihatAkunMenunggu(), setujuiAkun(), tolakAkun() |
| C14-03 | StatusAkun | MENUNGGU, DISETUJUI, DITOLAK | - |
