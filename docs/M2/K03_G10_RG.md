...
| Revisi | Deskripsi |
| :--- | :--- |
| A | Penyesuaian penomoran kebutuhan berdasarkan hasil asistensi Milestone 2. Kebutuhan pengguna, kebutuhan bisnis, dan kebutuhan sistem disusun berurutan berdasarkan aktivitas yang berkaitan. |
| | |
| | |
| | |
...
| R03 | A01 | System | Sistem mampu menerima data dari volume air dalam tangki, lalu diubah menjadi status normal/rendah/kritis sesuai ambang batas | Ya |
| R04 | A02 | User | Warga dapat melihat kondisi pasokan energi yang digunakan oleh pompa air, termasuk kapasitas baterai dan daya yang dihasilkan panel surya. | Ya |
| R05 | A02 | Business | Informasi kondisi daya harus menggunakan parameter dan satuan pengukuran yang konsisten agar kondisi pasokan energi dapat dibandingkan dan dipantau dari waktu ke waktu. | Ya |
| R06 | A02 | System | Sistem dapat menerima data dari daya baterai dan output daya panel surya yang kemudian disimpan dalam satuan pengukuran supaya dapat dipantau | Ya |
| R07 | A03 | User | Warga dapat melihat rincian tagihan iuran untuk periode berjalan, termasuk periode tagihan, data pemakaian yang menjadi dasar perhitungan, dan jumlah iuran yang harus dibayarkan. | Ya |
| R08 | A03 | Business | Besaran atau tarif yang digunakan sebagai dasar perhitungan iuran ditetapkan oleh pengurus komunitas sesuai kebijakan yang berlaku pada komunitas tersebut. | Tidak |
| R09 | A03 | Business | Tagihan iuran hanya dapat ditampilkan sebagai tagihan final kepada warga setelah perhitungan untuk periode tersebut ditetapkan oleh pengurus. | Ya |
| R10 | A03 | System | Sistem mampu menyimpan data tarif dan juga iuran, lalu dihitung berdasarkan tarif yang sudah dibuat pengurus, lalu menampilkan hasil akhir pada dasboard | Ya |
| R11 | A04 | User | Warga dapat membuat laporan gangguan infrastruktur dengan memberikan informasi mengenai gangguan yang ditemukan, seperti jenis gangguan, deskripsi, dan informasi pendukung yang relevan. | Ya |
| R12 | A04 | Business | Hanya warga yang terdaftar dalam komunitas yang dapat mengirimkan laporan gangguan terhadap infrastruktur komunal yang dikelola oleh komunitas tersebut. | Ya |
| R13 | A04 | Business | Setiap laporan gangguan yang berhasil dikirim harus tercatat sebagai laporan tersendiri dan memasuki proses penanganan dengan status awal **Menunggu**. | Ya |
| R14 | A04 | System | Sistem dapat untuk memverifikasi status keanggotaan saat menerima laporan serta menyimpan laporan baru dengan status "Menunggu" dengan lampiran seperti foto atau deskripsi bila ada | Ya |
| R15 | A05 | User | Warga yang mengirim laporan dapat melihat status terbaru dan perkembangan penanganan dari laporan gangguan tersebut. | Ya |
| R16 | A05 | Business | Status laporan gangguan harus mengikuti status penanganan yang telah ditetapkan, yaitu **Menunggu**, **Sedang Diperbaiki**, atau **Selesai**, sehingga progres penanganan dapat dipahami secara seragam oleh warga dan teknisi. | Ya |
| R17 | A05 | System | Sistem mampu mencari ataupun menelusuri status laporan berdasarkan identitas pelapor maupun ID laporan | Ya |
| R18 | A06 | User | Teknisi dapat menerima peringatan ketika kondisi daya baterai mencapai atau berada di bawah batas aman sehingga tindakan preventif dapat segera dilakukan. | Ya |
| R19 | A06 | Business | Nilai batas aman atau kondisi daya kritis ditentukan oleh teknisi atau pengurus dengan mengacu pada spesifikasi operasional perangkat yang digunakan. | Tidak |
| R20 | A06 | Business | Peringatan kondisi daya kritis harus ditujukan kepada pihak yang bertanggung jawab terhadap pemeliharaan perangkat, yaitu teknisi yang terdaftar. | Ya |
| R21 | A06 | System | Sistem mampu memantau daya baterai dan memberikan notifikasi pada teknisi apabila berada di bawah ambang batas | Ya |
| R22 | A07 | User | Teknisi dapat melihat riwayat dan kecenderungan kinerja panel surya dalam suatu rentang waktu untuk membantu mendeteksi penurunan performa perangkat. | Ya |
| R23 | A07 | Business | Data historis kinerja perangkat harus dapat digunakan sebagai salah satu dasar evaluasi kondisi perangkat dan perencanaan kegiatan pemeliharaan oleh teknisi. | Ya |
| R24 | A07 | System | Sistem menyimpan data historis panel surya dan menyediakan visualisasi grafik tren performa. | Ya |
| R25 | A08 | User | Teknisi dapat memperbarui status penanganan laporan gangguan sesuai dengan progres pekerjaan yang dilakukan di lapangan. | Ya |
| R26 | A08 | Business | Perubahan status penanganan gangguan hanya dapat dilakukan oleh teknisi yang memiliki kewenangan untuk menangani laporan tersebut. | Ya |
| R27 | A08 | Business | Perubahan status laporan harus menggunakan tahapan penanganan yang telah ditetapkan, yaitu **Menunggu**, **Sedang Diperbaiki**, dan **Selesai**, sesuai kondisi aktual penanganan gangguan. | Ya |
| R28 | A08 | System | Sistem memastikan hanya teknisi yang dapat mengubah status laporan gangguan dan mencatat perubahan status & waktunya  | Ya |
| R29 | A09 | User | Teknisi dapat mencatat kegiatan pemeliharaan atau perbaikan perangkat, termasuk perangkat yang ditangani, waktu pelaksanaan, tindakan yang dilakukan, dan catatan hasil pemeliharaan. | Ya |
| R30 | A09 | Business | Setiap kegiatan pemeliharaan atau perbaikan yang telah dilakukan terhadap infrastruktur komunal harus didokumentasikan agar riwayat penanganan perangkat dapat ditelusuri kembali. | Ya |
| R31 | A09 | Business | Pelaksanaan pemeliharaan atau perbaikan fisik perangkat dilakukan oleh pihak yang berwenang dan mengikuti prosedur pemeliharaan yang berlaku pada perangkat terkait. | Tidak |
| R32 | A09 | System | Sistem menyediakan struktur basis data untuk mencatat riwayat pemeliharaan dan perbaikan yang dapat ditelusuri kembali kapan pun diperlukan. | Ya |
| R33 | A10 | User | Pengurus dapat melihat data agregat dan riwayat pemakaian air serta energi komunal melalui dashboard untuk mendukung evaluasi dan pengambilan keputusan. | Ya |
| R34 | A10 | Business | Informasi pengelolaan pada dashboard yang bersifat administratif dan mencakup keseluruhan komunitas hanya dapat diakses oleh pengurus yang memiliki kewenangan. | Ya |
| R35 | A10 | Business | Data pemakaian yang digunakan dalam evaluasi komunitas harus dikelompokkan berdasarkan periode yang konsisten agar hasil analisis dapat dibandingkan antarperiode. | Ya |
| R36 | A10 | System | Sistem mengumpulkan data pemakaian air dan energi berdasarkan periode yang konsisten. | Ya |
| R37 | A11 | User | Pengurus dapat mengolah data pemakaian warga pada suatu periode menjadi perhitungan iuran yang harus dibayarkan oleh masing-masing warga. | Ya |
| R38 | A11 | Business | Tarif atau aturan perhitungan iuran ditentukan melalui kebijakan pengelolaan komunitas dan menjadi dasar yang berlaku untuk perhitungan iuran pada periode terkait. | Tidak |
| R39 | A11 | Business | Hanya pengurus yang memiliki kewenangan yang dapat melakukan dan menetapkan hasil perhitungan iuran warga. | Ya |
| R40 | A11 | Business | Seluruh perhitungan iuran dalam periode tagihan yang sama harus menggunakan aturan dan tarif yang berlaku untuk periode tersebut agar perhitungan dilakukan secara konsisten. | Ya |
| R41 | A11 | System | Sistem menyediakan modul kalkulasi otomatis iuran berdasarkan data pemakaian dan tarif yang berlaku pada periode terkait. | Ya |
| R42 | A12 | User | Pengurus dapat mengekspor atau mencetak rekapitulasi data pemakaian dan iuran komunitas untuk periode yang dipilih. | Ya |
| R43 | A12 | Business | Hak untuk menghasilkan rekapitulasi administratif komunitas diberikan kepada pengurus yang memiliki kewenangan atas pengelolaan data tersebut. | Ya |
| R44 | A12 | Business | Rekapitulasi resmi suatu periode harus menggunakan data pemakaian dan data iuran yang telah ditetapkan untuk periode tersebut agar informasi yang dilaporkan konsisten dengan data pengelolaan komunitas. | Ya |
...
| KF33 | R10 | Perangkat lunak dapat menghitung tagihan iuran dari warga secara otomatis berdasarkan data pemaiakan dan juga tarif yang berlaku di periode yang terkait |
...
| :--- | :--- | :--- | :--- |
| KNF01 | R12, R26, R34, R39, R43 | Security | Selama pengguna menggunakan sistem, sistem harus membatasi akses fitur yang muncul pada dasbor pengguna sesuai dengan kewenangannya. |
| KNF02 | R07, R11, R15, R29, R33 | Security | Ketika pengguna membuka data pada sebuah fitur, sistem harus dapat menampilkan data sesuai kewenangan pengguna. |
| KNF03 | R13, R18, R20 | Reliability | Bila koneksi jaringan terputus saat pengiriman sebuah data, maka sistem harus mampu menyimpan data sementara untuk pengiriman setelah koneksi pulih. |
...
| KNF05 | R18, R20 | Safety | Bila kapasitas baterai sudah melewati batas aman, maka sistem harus mampu mengirimkan peringatan kepada teknisi yang bertanggung jawab paling lama 3 detik setelah sistem menerima data kondisi kritis. |
| KNF06 | R01, R04, R33 | Availability | Selama jam operasional komunitas, sistem harus dapat diakses oleh pengguna dengan ketersediaan sistem setidaknya 99% tiap bulan. |
| KNF07 | R01, R04, R07, R11, R15 | Ergonomy | Warga dapat mengoperasikan User Interface software dengan mudah tanpa harus melakukan panduan pelatihan khusus terlebih dahulu. |
| KNF08 | R22, R25, R29 | Ergonomy | Teknisi dapat mengakses User Interface pencatatan lapangan secara responsif melalui smartphone. |
| KNF09 | R01, R11, R33 | Portability | Pengguna dapat membuka platform website melalui berbagai web browser atau perangkat tanpa memerlukan instalasi aplikasi tambahan. |
| KNF10 | R45 | Portability | Ssitem mengekspor berkas rekapitulasi ke dalam format yang universal berupa PDF atau CSV. |
| KNF11 | R03, R06 | Response time | Sistem dapat memperbarui nilai input dari sensor pada dashboard dalam waktu maksimal 2 detik. |
| KNF12 | R41 | Response time | Sistem dapat menyelesaikan kalkulasi otomatis iuran komunal dalam waktu maksimal 5 detik. |
| KNF13 | R03, R06 | Memory | Sistem mengeksekusi firmware pembacaan sensor tanpa melebihi batas memori internal mikrokontroler. |
